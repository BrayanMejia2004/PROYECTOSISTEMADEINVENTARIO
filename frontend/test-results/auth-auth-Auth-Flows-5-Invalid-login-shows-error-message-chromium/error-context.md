...
- Name: auth\auth.spec.ts >> Auth Flows >> 5. Invalid login shows error message
- Location: e2e\auth\auth.spec.ts:51:3
...
Call log:
  - waiting for getByLabel('Slug del Tenant')
...
- generic [ref=e5]:
  - generic [ref=e6]:
    ...
    - paragraph [ref=e14]: Ingresa a tu panel de inventario
  - generic [ref=e15]:
    - generic [ref=e16]:
      - generic [ref=e17]: Slug del Tenant
      - textbox "mi-empresa" [ref=e18]
    - generic [ref=e19]:
