        ...
        <div className="p-6 space-y-5">
          ...
          {sale.status === 'completed' && (
            <div className="flex gap-2 pt-2">
              ...
              <button className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-gray-200 text-brand-muted text-sm font-medium hover:bg-gray-50 transition-colors">
